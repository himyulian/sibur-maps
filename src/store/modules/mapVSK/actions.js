...
export async function actFetchMapVSKmodePROD ({ commit }) {
  try {
    ...
    let d1Landuse           = await axios.get('https://sharepoint/orgunits/vsk/map/SiteAssets/GeoJSON/VSK/EPSG4326/vsk_D1_landuse.geojson')
    let d1Construnctions    = await axios.get('https://sharepoint/orgunits/vsk/map/SiteAssets/GeoJSON/VSK/EPSG4326/vsk_D1_construnctions.geojson')
    let d1Railways          = await axios.get('https://sharepoint/orgunits/vsk/map/SiteAssets/GeoJSON/VSK/EPSG4326/vsk_D1_railways.geojson')
    let d1Roads             = await axios.get('https://sharepoint/orgunits/vsk/map/SiteAssets/GeoJSON/VSK/EPSG4326/vsk_D1_roads.geojson')
    let o61Landuse          = await axios.get('https://sharepoint/orgunits/vsk/map/SiteAssets/GeoJSON/VSK/EPSG4326/vsk_61_landuse.geojson')
    let o61Construnctions   = await axios.get('https://sharepoint/orgunits/vsk/map/SiteAssets/GeoJSON/VSK/EPSG4326/vsk_61_construnctions.geojson')
    let o61Roads            = await axios.get('https://sharepoint/orgunits/vsk/map/SiteAssets/GeoJSON/VSK/EPSG4326/vsk_61_roads.geojson')
    commit('setLoadingStatus', false)
    let response = {
      main: {
        landuse: mainLanduse.data,
